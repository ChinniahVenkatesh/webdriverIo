...
function _async() {
  _async = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(fileName, options) {
    var base64Image;
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            if (_lodash["default"].isPlainObject(fileName) && _lodash["default"].isUndefined(options)) {
              options = fileName;
              fileName = undefined;
            ...
            _context.next = 3;
            return (0, _makeViewportScreenshot["default"])(this, options);
