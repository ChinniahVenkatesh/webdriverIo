...
var log = (0, _logger["default"])('wdio-novus-visual-regression-service:afterScreenshot');
...
function _afterScreenshot() {
  _afterScreenshot = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(browser, options) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return browser.execute(_modifyElements["default"], options.hide, 'opacity', '');
          ...
          case 4:
            ...
            _context.next = 8;
            return browser.execute(_modifyElements["default"], options.remove, 'display', '');
