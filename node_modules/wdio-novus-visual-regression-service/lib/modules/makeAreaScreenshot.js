...
var log = (0, _logger["default"])('wdio-novus-visual-regression-service:makeAreaScreenshot');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            log.info('crop screenshot with width: %s, height: %s, offsetX: %s, offsetY: %s', cropDimensions.getWidth(), cropDimensions.getHeight(), cropDimensions.getX(), cropDimensions.getY());
            _context.next = 6;
