...
var log = (0, _logger["default"])('wdio-novus-visual-regression-service:beforeScreenshot');
...
function _beforeScreenshot() {
  _beforeScreenshot = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(browser, options) {
    var x, y, pause;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            _context.next = 10;
            return browser.execute(_modifyElements["default"], options.hide, 'opacity', '0');
          ...
          case 10:
            ...
            _context.next = 14;
            return browser.execute(_modifyElements["default"], options.remove, 'display', 'none');
