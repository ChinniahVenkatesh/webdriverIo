...
exports["default"] = normalizeSreenshot;
...
var _getBase64ImageSize = _interopRequireDefault(require("./getBase64ImageSize"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            size = (0, _getBase64ImageSize["default"])(base64Screenshot);
            ...
            _context.next = 9;
            return (0, _image.scaleImage)(base64Screenshot, 1 / screenDimensions.getPixelRatio());
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            cropDimensions = new _CropDimension["default"](viewportWidth, viewportHeight, 0, barsHeight, true, rotation);
            _context2.next = 17;
            return (0, _image.cropImage)(base64Screenshot, cropDimensions);
...
function normalizeSreenshot(_x7, _x8, _x9) {
  return _normalizeSreenshot.apply(this, arguments);
}

function _normalizeSreenshot() {
  _normalizeSreenshot = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(browser, screenDimensions, base64Screenshot) {
